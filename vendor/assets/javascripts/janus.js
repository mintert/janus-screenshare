...
function Janus(gatewayCallbacks) {
	...
	function handleEvent(json) {
		...
		if(json["janus"] === "keepalive") {
			...
			var callback = pluginHandle.onwebrtcup;
	...
	function createHandle(callbacks) {
		...
		callbacks.onwebrtcup = (typeof callbacks.onwebrtcup == "function") ? callbacks.onwebrtcup : jQuery.noop;
				...
				var pluginHandle =
					{
						...
						onwebrtcup: callbacks.onwebrtcup,
